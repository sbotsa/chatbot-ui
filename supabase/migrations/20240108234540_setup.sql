...
AS $$
DECLARE
  project_url TEXT := 'https://eszqlellcqpfwbzinlti.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVzenFsZWxsY3FwZndiemlubHRpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTkxNDg0NiwiZXhwIjoyMDYxNDkwODQ2fQ.vbb8yxvc3RlVPKrgckmJg0WbCZd-QLXsLP2X8tmfS-Y'; -- full access needed for http request to storage
